    ...
    <>
        ...
        <div className={styles.homeContainer}>
          ...
          <div className={styles.homeContent}>
            ...
            <p className={styles.para}>
              ...
              functional as they are gorgeous. I love turning code into
              seamless, interactive experiences. My focus is on building modern,
              responsive, and easy-to-use web applications.
            </p>
      ...
      <div className={styles.projectBtnWrapper}>
        <Link to="/projects" className={styles.projectBtn}>
          <Icons.RiComputerFill size={35} /> Explore my Projects
        </Link>
      </div>
      <About />
    </>
